  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-zinc-950 via-zinc-900 to-zinc-950 text-zinc-100">
      ...
      <header className="sticky top-0 z-50 backdrop-blur supports-[backdrop-filter]:bg-zinc-950/60 border-b border-white/10">
        <div className="mx-auto max-w-7xl px-4 py-3 flex items-center justify-between">
          <div className="flex items-center gap-3">
            <div className="h-9 w-9 rounded-xl bg-gradient-to-tr from-orange-400 to-yellow-400 shadow-lg grid place-items-center font-black text-zinc-900">
              V
            </div>
            <div>
      ...
      <section id="overview" className="relative overflow-hidden">
        <div className="absolute inset-0 -z-10 opacity-25 bg-[radial-gradient(70%_50%_at_50%_0%,rgba(251,191,36,0.35),transparent_60%)]" />
        <div className="mx-auto max-w-7xl px-4 py-16 grid md:grid-cols-[1.2fr_0.8fr] gap-10 items-center">
          <div>
            ...
            <p className="mt-4 text-zinc-300 md:text-lg">
              ...
              <span className="font-semibold">ฟลีทกว่า 300 คัน</span>{" "}
          ...
          <div className="relative">
            <div className="rounded-3xl border border-white/10 p-6 backdrop-blur bg-white/5">
              <div className="flex items-center justify-between gap-6">
                ...
                <div className="flex-1 text-center">
                  <div className="mx-auto h-12 w-12 rounded-xl bg-gradient-to-tr from-orange-400 to-yellow-400 text-zinc-900 grid place-items-center font-black">
                    S
                  </div>
                  <p className="mt-2 text-xs text-zinc-400">Speed Auto</p>
                </div>
              </div>
